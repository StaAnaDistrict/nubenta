...
// require_once 'includes/NotificationHelper.php'; // If needed by navigation
...
<head>
    ...
    <style>
        /* Styles specific to this page or minor overrides */
        .user-list-item { display: flex; align-items: center; margin-bottom: 15px; padding: 10px; border: 1px solid #eee; border-radius: 8px; background-color: #fff; }
        .user-list-item img { width: 50px; height: 50px; border-radius: 50%; margin-right: 15px; object-fit: cover; }
        .user-list-item .user-info a { font-weight: bold; text-decoration: none; color: #333; }
        .user-list-item .user-info a:hover { text-decoration: underline; }
        .pagination .page-link { color: #333; }
        .pagination .page-item.active .page-link { background-color: #333; border-color: #333; color: #fff; }
        .dashboard-grid > .main-content .content-area .main-content-column { padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 1px 2px rgba(0,0,0,0.1); }
        .content-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; padding-bottom: 15px; border-bottom: 1px solid #dee2e6; }
        .content-header h3 { margin: 0; font-size: 1.75rem; }
    </style>
</head>
<body>
                            ...
                            <div class="user-list">
                                <?php foreach ($followingList as $followedUser): ?>
                                    ...
                                    <div class="user-list-item">
                                        <img src="<?= htmlspecialchars($profilePic) ?>" alt="<?= htmlspecialchars($followedUser['full_name']) ?>'s Profile Picture">
                                        <div class="user-info">

...
class CommentSystem {
  ...
  addCommentToUI(postId, comment, prepend = false) {
    ...
    commentElement.innerHTML = `
      <div class="d-flex">
        <img src="${comment.profile_pic || defaultProfilePic}" alt="${comment.author}" class="rounded-circle me-2" width="32" height="32">
  ...
  createReplyHTML(reply) {
    ...
    return `
      <div class="reply mt-2" data-reply-id="${reply.id}">
        <div class="d-flex">
          <img src="${reply.profile_pic || defaultProfilePic}" alt="${reply.author}" class="rounded-circle me-2" width="24" height="24">
